...
<div class="small-container single-product">
    ...
    $id=$_GET['id'];
    $query = " SELECT * FROM `featureproduct` WHERE id='$id' ";
...
<form action="insertcart.php" method="post">
    <div class="row">
        ...
        <div class="col-2">
            <input type="text" value="<?php echo $product['prodtype']; ?>" class="inputdetail" name="prodtype" readonly >
            <h1><input type="text" value="<?php echo $product['name']; ?>" name="name" class="inputdetail" readonly >
</h1>                
            <h4><input type="text" value="<?php echo $product['price']; ?>" name="price" class="inputdetail" readonly ></h4>
            <select name="size" >
